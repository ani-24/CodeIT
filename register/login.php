  ...
  <body>
    <?php
        ...
        if (isset($_POST['submit'])) {
          ...
          if ($row > 0) {
            $mysqli_array = mysqli_fetch_assoc($email_result);
            $email_pass = $mysqli_array['pass'];
            $_SESSION['fname'] = $mysqli_array['fname'];
            $_SESSION['lname'] = $mysqli_array['lname'];
            $pass_verify = password_verify($pass, $email_pass);
            if ($pass_verify) {
            ...
            echo '<script>alert("Email does not exist. If you are a new user, try signing in");</script>';
          }
        }
  	...
  	<div class="container">
	  	<div class="row">
	  		<div class="col-md-2 col-sm-12">
	  			...
	  			<p class="desc text-white text-center" style="font-size: .85rem;">Login to your free accout for CodeIT.</p>
	  		</div>
	  			...
	  			<div class="main">
	  				<form action="<?php echo htmlentities($_SERVER['PHP_SELF']); ?>" method="post">
	  					<div class="row">
	  						...
	  						<div class="col-md-6 col-sm-12">
	  							<div class="form-group">
	  								<input type="password" id="pass" placeholder="Enter your password" name="pass" class="form-control">
	  							</div>
	  						</div>
							<div class="col-12 text-center m-3">Not a user? <a href="register.php" style="text-decoration: none;">Register</a></div>
